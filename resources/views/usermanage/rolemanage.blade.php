...
@section('only_css')
    ...
    .msg-error i {
        ...
        background:url('{{asset("plugins/js/plugins/layer/skin/default/icon.png")}}') no-repeat -192px 0!important;
    }
    .table>tbody>tr>td{
        font-size: 14px;
    }
...
@section('only_js')
    <script src="{{asset('admin/usermanage/rolemanage.js')}}"></script>
...
@section('layer_content')
    <form class="form-horizontal validation-form" id="Form1" novalidate="novalidate" method="post" action="{{url('/auth/add-new-role')}}">
        ...
        <div class="modal-footer">
            <button type="submit" class="btn btn-success notAgree" id='sure' data-dismiss="modal" aria-hidden="true">确定</button>
