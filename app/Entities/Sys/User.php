...
//    protected $hidden 		= 	['password','openid'];
    protected $fillable 	=	['username','name','code','password','openid','mobile','nickname','gender','qq','weixinnickname','country','province','city','adress','avatar','email','lastlogindate','idcard_type','idcard','status','remember_token']  ;
