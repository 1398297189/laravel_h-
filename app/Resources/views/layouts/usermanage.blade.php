...
<link href="{{asset('msc/wechat/common/js/jquery-confirm/jquery-confirm.css')}}" rel="stylesheet">
...
<!-- �Զ���js -->
<script src="{{asset('msc/wechat/common/js/jquery-confirm/jquery-confirm.js')}}"></script>
@stop
@section('head_style')
<style type="text/css">
